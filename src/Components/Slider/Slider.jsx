...
import { nextSlide, prevSlide, dotSlide } from '../../features/Slider/SliderSlices'
...
const Slider = () => {
    ...
    console.log("Slider Value ", slideIndex)
    ...
    return (
        <div className="relative pb-4">
              ...
              return (
                <div className="mr-4" key={dot.id}>
                  <div
                    className={
                      index === slideIndex
                        ? "bg-orange-900 rounded-full p-2 cursor-pointer"
          ...
          <div>
            <button
              className="absolute top-[50%] right-4 bg-white rounded-full p-2 hover:bg-orange-700"
            ...
            <button
              className="absolute top-[50%] left-4 bg-white rounded-full p-2 hover:bg-orange-700"
